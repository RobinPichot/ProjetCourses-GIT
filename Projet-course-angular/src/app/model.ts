...
export class Restaurant {
    ...
    constructor(id?:number, nom?: string, ouvert?: boolean, notation?: number, descriptionRestaurant?: string, menu?:Array<Plat>,adresse?: Adresse, restaurateur?: Restaurateur) {
        this.id = id;
        this.nom = nom || "";
        this.ouvert = ouvert;
